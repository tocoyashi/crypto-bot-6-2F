...
def run_backtest():
    ...
    print(f"Fetching 6 months of data for {len(SYMBOLS)} coins...")
    ...
    for symbol in SYMBOLS:
        try:
            ...
            for i in range(100, len(df_15m)): 
                ...
                future_candles = df_15m.iloc[i+1:]
    ...
    print("\n" + "="*60)
    print("📊 BACKTEST REPORT — 6 MONTHS (65% / 35% PARTIAL CLOSE & FEES)")
    print("="*60)
