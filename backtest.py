...
TP1_PCT = 1.0105  
TP2_PCT = 1.025   
SL_PCT = 0.965     # ✨ Changed to -3.5% (1 - 0.035)
BE_SL_PCT = 1.0025 
...
def run_backtest():
        ...
        try:
            ...
            for i in range(100, len(df_15m) - 96): 
                ...
                if direction == "LONG":
                    ...
                    tp1_raw, tp2_raw, sl_raw, be_raw = 1.05, 2.5, -3.5, 0.25 # ✨ SL Raw changed to -3.5
                else:
    ...
    print("\n" + "="*60)
    print("📊 BACKTEST REPORT (SL TIGHTENED TO -3.5% & FEES)")
    print("="*60)
